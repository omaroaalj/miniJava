...
public class MiniJavaParser extends Parser {
	...
	public static final int
		...
		NAME=38, STRING=39, LINE_COMMENT=40, BLOCK_COMMENT=41;
	public static final int
	...
	public final ClassNodeContext classNode() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 282394101760L) != 0) {
				{
				{
				setState(41);
	...
	public final MethodContext method() throws RecognitionException {
		...
		try {
			...
			case NAME:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 282394099712L) != 0) {
					{
					setState(96);
	...
	public final MethodBodyContext methodBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 1072672268872L) != 0) {
				{
				{
				setState(141);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 1065156051008L) != 0) {
					{
					setState(212);
